        ...
        my class RouteHandler does Handler {
            ...
            method copy-adding(:@prefix, :@body-parsers!, :@body-serializers!, :@before-matched!, :@after-matched!, :@around!,
                ...
                self.bless:
                    ...
                    |(name => ($name-prefix ?? "$name-prefix." !! '') ~ $!name with $!name),
